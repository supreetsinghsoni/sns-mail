	...
	<caption><h1>Recovering Password.... </h1>
		...
		<form method="post" enctype="multipart/form-data">
			...
			<tr>
			  ...
			  <td width="145"><input type="email" placeholder="abc@gmail.com" name="e" required></td>
			</tr>
			<tr>
				<td>Your First Phone Number</td>
                <td><input type="text" placeholder="Enter First Phone Number" name="fmn" required></td>
            </tr> 
            <tr>
                <td>Your Mobile Number</td>
                <td><input type="number" placeholder="Enter Mobile Number" name="m"required></td>
            </tr>
			<tr>
                <td>Your New Password</td>
                <td><input type="password" placeholder="Enter New Password" name="np"required></td>
            </tr>
			<tr>
                <td>Your Confirm Password</td>
                <td><input type="password" placeholder="Enter Confirm Password" name="cp" required></td>
            </tr>
            <tr>
